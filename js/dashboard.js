(function($) {
  ...
  $(function() {
    if ($("#performaneLine").length) {
      ...
      saleGradientBg.addColorStop(0, 'rgba(144, 238, 144, 0.18)'); // Light Green
      saleGradientBg.addColorStop(1, 'rgba(144, 238, 144, 0.02)'); // Light Green
      var saleGradientBg2 = graphGradient2.createLinearGradient(100, 0, 50, 150);
      saleGradientBg2.addColorStop(0, 'rgba(0, 128, 0, 0.19)'); // Dark Green
      saleGradientBg2.addColorStop(1, 'rgba(0, 128, 0, 0.03)'); // Dark Green
      var salesTopData = {
    ...
    if ($("#performaneLine-dark").length) {
      ...
      // Change blue to green in the first gradient (saleGradientBg)
      var saleGradientBg = graphGradient.createLinearGradient(5, 0, 5, 100);
      saleGradientBg.addColorStop(0, 'rgba(0, 200, 100, 0.18)'); // Green color with alpha 0.18
      saleGradientBg.addColorStop(1, 'rgba(34, 36, 55, 0.5)');
      
      // Change blue to green in the second gradient (saleGradientBg2)
      var saleGradientBg2 = graphGradient2.createLinearGradient(10, 0, 0, 150);
      saleGradientBg2.addColorStop(0, 'rgba(0, 255, 0, 0.19)'); // Green color with alpha 0.19
